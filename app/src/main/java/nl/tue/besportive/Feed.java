        ...
        view.findViewById(R.id.profile_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(Feed.this)
                        .navigate(R.id.action_feed_to_profile);
            }
        });
        view.findViewById(R.id.leaderboard_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(Feed.this)
                        .navigate(R.id.action_feed_to_leaderboard2);
            }
        });
        view.findViewById(R.id.challenges_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(Feed.this)
                        .navigate(R.id.action_feed_to_challenges2);
            }
        });
    }
}